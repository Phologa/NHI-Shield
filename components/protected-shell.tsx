...
const navigation = [
  { label: "Overview", href: "/overview" }, { label: "Machine Identities", href: "/machine-identities" },
  { label: "Access Graph", href: "/access-graph" }, { label: "Findings", href: "/findings" },
  { label: "Incidents", href: "/incidents" }, { label: "AI Security Analyst", href: "/ai-analyst" },
  { label: "Remediation", href: "/remediation" }, { label: "Audit Log", href: "/audit-log" }, { label: "Settings", href: "/settings" },
];
