...
| `202608200008_inventory_bundle_import.sql` | One-file inventory import, external-key mapping, provenance, conflict preservation, and analysis status | Phase 2 complete locally | Unapplied; depends on migration 007 only by sequence, not schema |
