...
| `202608200007_foundation_membership_hardening.sql` | User profiles, audited invite acceptance, and RPC-only invite/member mutations | Versioned | Verify in target Supabase; the final code release did not apply migrations |
